...
| 🗺 **نقشهٔ قلمروها** | ۶ قلمرو مشترک؛ بازیکنان هم‌زمان به یک قلمرو حمله می‌کنند؛ قلمرو سقوط‌کرده به اتحادیهٔ بهترین مهاجم می‌رسد و سطحش بالا می‌رود |
...
| 🏅 **فروشگاه ویژه** | بستهٔ انرژی، طلسم پیروزی، آهنربای غنیمت، کتاب آموزش، کیت تعمیر، جعبهٔ تانک و موشک |
...
## 🎮 منوی شیشه‌ای پایین چت — ساختار جدید (۶ دسته)
...
```
[ 🏠 پایگاه ]  [ 🪖 ارتش ]  [ 🛡 دفاع ]
[ ⚔️ نبرد   ]  [ 🏰 اتحادیه] [ 🛒 فروشگاه ]
```

### ناوبری
- پایین چت = **دسته‌های اصلی** (همیشه قابل مشاهده، ۲ ردیف سه‌تایی)
...
| 🏰 **اتحادیه** | 🏰 اتحادیه من، 📋 لیست اتحادیه‌ها، ⚔️ جنگ / وضعیت جنگ، 💰 خزانه، 🗺 قلمروها (با ارتقا) |
...
> 💡 **بقیه قابلیت‌ها همه داخل منوی دکمه‌ای هستند** — برای پروفایل، آموزش یگان، دفاع، نبرد، اتحادیه، قلمرو، معدن، مأموریت، فروشگاه، نمودار و رده‌بندی فقط از دکمه‌های پایین چت استفاده کن؛ نیازی به تایپ دستور نیست. دستور `/help` همچنان راهنمای کامل را نشان می‌دهد.
...
- محدودیت‌های اسپم: کول‌داون ۹۰ ثانیه‌ای حمله به یک حریف و ۳۰ ثانیه‌ای حمله به قلمرو
...
- سیستم‌های قبلی (حمله، جنگ، فروشگاه، مأموریت، اتحادیه، قلمرو، اقتصاد) دست‌نخورده‌اند
